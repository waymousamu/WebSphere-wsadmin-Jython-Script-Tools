...
CONFDICT_BASE = [
                 ...
                 {'Cell': {'name': 'SYMECell01'}},
                 {'PMIRequestMetrics' : {'traceLevel' : 'PERF_DEBUG', 'scope': '/Cell:SYMECell01/', 'armTransactionFactory' : '', 'dynamicEnable' : 'true', 'enable' : 'true', 'armType' : 'ARM40', 'enableLog' : 'true', 'enableARM' : 'false'}},
                 {'JAASAuthData': {'password': '{xor}LDo8LTor', 'userId': 'swaymouth', 'alias': 'dps_oracle_alias', 'scope': '/Cell:SYMECell01/'}},
                 {'dmgr': {'port': '8880', 'host': 'altus3400.dovetail.net'}},
                 {'VirtualHost': {'name': 'VH_test', 'scope': '/Cell:SYMECell01/'}}, 
                 {'HostAlias': {'port': '9020', 'hostname': '*', 'scope': '/VirtualHost:VH_test/'}}, 
                 {'HostAlias': {'port': '9120', 'hostname': '*', 'scope': '/VirtualHost:VH_test/'}},  
                 {'Node': {'name': 'node01', 'scope': '/Cell:SYMECell01/'}},
                 {'Server': {'name': 'srv01', 'scope': '/Node:node01/'}},
                 {'ProcessExecution': {'runAsUser': 'websphere', 'runAsGroup': 'websphere', 'scope': '/Server:srv01/'}},
                 {'JavaVirtualMachine': {'scope': '/Server:srv01/', 'genericJvmArguments': '-DQ5INSTANCEID=1 -DQ5PINTRANSACTIONS=true -DSTPBULKSIZE=100 -DQ5CACHEFILTER=com.dovetailsys.shared.util.CacheFilter -DQ5CACHEOBJECTS=1024 -Dcom.dovetailsystems.q5.useLOBs=No -Dperform.bic.lookup=yes -Dperform.iban.validation=no -DQ5TRANSACTION_TIMEOUT=600 -DDEFAULT_GATEWAY_ROOT=/gateway -Dcom.ibm.CORBA.iiop.noLocalCopies=true -Xgcpolicy:gencon -Xcompressedrefs -Xnoclassgc', 'maximumHeapSize': '2048', 'initialHeapSize': '1024'}},
                 {'EJBCache': {'cleanupInterval': '0', 'scope': '/Server:srv01/', 'cacheSize': '2000'}},
                 {'PMIService': {'enable': 'true', 'scope': '/Server:srv01/', 'statisticSet': 'all'}},
                 {'JDBCProvider': {'classpath': '${ORACLE_JDBC_DRIVER_PATH}/ojdbc6.jar', 'name': 'XADPSJDBCProvider', 'implementationClassName': 'oracle.jdbc.xa.client.OracleXADataSource', 'scope': '/Cell:SYMECell01/', 'description': 'XADPSJDBCProvider', 'providerType': 'Oracle JDBC Driver (XA)', 'xa': 'true'}},
                 ...
                 {'JDBCProvider': {'classpath': '${ORACLE_JDBC_DRIVER_PATH}/ojdbc6.jar', 'name': 'DPSJDBCProvider', 'implementationClassName': 'oracle.jdbc.pool.OracleConnectionPoolDataSource', 'scope': '/Cell:SYMECell01/', 'description': 'DPSJDBCProvider', 'providerType': 'Oracle JDBC Driver', 'xa': 'false'}},
                 ...
                 {'MQQueueConnectionFactory': {'transportType': 'BINDINGS_THEN_CLIENT', 'port': '1414', 'name': 'QCF1', 'scope': '/Cell:SYMECell01/', 'host': 'localhost', 'channel': 'CH1', 'queueManager': 'QM1', 'jndiName': 'jms/QCF1'}},
                 ...
                 {'MQQueue': {'name': 'AccountingHVMessageSendQueue', 'baseQueueName': 'AccountingHVMessageSendQueue', 'serverConnectionChannelName': 'CH1', 'baseQueueManagerName': 'QM1', 'jndiName': 'dovetail/jms/AccountingHVMessageSendQueue', 'queueManagerHost': 'localhost', 'persistence': 'PERSISTENT', 'scope': '/Cell:SYMECell01/', 'queueManagerPort': '1414'}},
                 {'SIBus': {'name': 'DovetailSIBus', 'scope': '/Cell:SYMECell01/'}},
                 ...
                 {'SIBQueue': {'identifier': 'AsyncActionQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'IntFilterReleasePaymentsQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'EBACreditTransferSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'EBADirectDebitSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01',}},
                 {'SIBQueue': {'identifier': 'EBADirectDebitB2BSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'CustomerAndAccountReceiveQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'OFCLVRequestMessageSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'OFCLVResponseMessageReceiveQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'OFCHVRequestMessageSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'OFCHVResponseMessageReceiveQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'GFCHVRequestMessageSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'GFCHVResponseMessageReceiveQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'GFCLVResponseMessageReceiveQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'AccountingNotificationQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'AdvisingNotificationQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'DDAExternalLookupRequestQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'DDAExternalLookupResponseQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'AccountingLVMessageSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'SIBQueue': {'identifier': 'AccountingHVMessageSendQueue', 'scope': '/SIBus:DovetailSIBus/', 'node': 'node01', 'server': 'srv01'}},
                 {'J2CActivationSpec': {'destinationJndiName': 'dovetail/jms/CacheUpdateTopic', 'name': 'CacheUpdateTopic', 'scope': '/Cell:SYMECell01/', 'jndiName': 'jms/CacheUpdateTopic'}},
                 ...
                 {'J2CActivationSpec': {'destinationJndiName': 'dovetail/jms/AsyncActionQueue', 'name': 'AsyncActionMDBeanActivation', 'scope': '/Cell:SYMECell01/', 'jndiName': 'jms/AsyncActionQueue'}},
                 ...
                 {'J2CActivationSpec': {'destinationJndiName': 'dovetail/jms/AsyncActionQueue', 'name': 'IntFilterMDBeanActivation', 'scope': '/Cell:SYMECell01/', 'jndiName': 'jms/IntFilterReleasePaymentsQueue'}},
                 ...
                 {'J2CActivationSpec': {'destinationJndiName': 'dovetail/jms/ATRMatchPaymentsQueue', 'name': 'ATRMatchingMDBeanActivation', 'scope': '/Cell:SYMECell01/', 'jndiName': 'jms/ATRMatchPaymentsQueue'}},
                 ...
                 {'J2CActivationSpec': {'destinationJndiName': 'dovetail/jms/ReportGenerationMessageQueue', 'name': 'ReportGenerationMessageBeanActivation', 'scope': '/Cell:SYMECell01/', 'jndiName': 'jms/ReportGenerationMessageQueue'}},
                 ...
                 {'J2CAdminObject': {'name': 'CacheUpdateTopic', 'scope': '/Cell:SYMECell01/', 'jndiName': 'dovetail/jms/CacheUpdateTopic'}},
                 ...
                 {'J2CConnectionFactory': {'name': 'DovetailJMSXAQueueConnectionFactory', 'authDataAlias': 'evps-waymouthsNode/swaymouth', 'scope': '/Cell:SYMECell01/', 'xaRecoveryAuthAlias': 'evps-waymouthsNode/swaymouth', 'jndiName': 'dovetail/jms/XAQueueConnectionFactory'}},
                 ...
                 {'J2CConnectionFactory': {'name': 'DovetailJMSQueueConnectionFactory', 'authDataAlias': 'evps-waymouthsNode/swaymouth', 'scope': '/Cell:SYMECell01/', 'jndiName': 'dovetail/jms/QueueConnectionFactory'}},
                 ...
                 {'J2CConnectionFactory': {'name': 'DovetailJMSXATopicConnectionFactory', 'authDataAlias': 'evps-waymouthsNode/swaymouth', 'scope': '/Cell:SYMECell01/', 'xaRecoveryAuthAlias': 'evps-waymouthsNode/swaymouth', 'jndiName': 'dovetail/jms/XATopicConnectionFactory'}},
