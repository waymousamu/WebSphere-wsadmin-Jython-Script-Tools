...
CONFDICT_BASE = [
                 ...
                 {'Cell': {'name': 'cell01'}},
                 {'PMIRequestMetrics' : {'traceLevel' : 'PERF_DEBUG', 'scope': '/Cell:cell01/', 'armTransactionFactory' : '', 'dynamicEnable' : 'true', 'enable' : 'true', 'armType' : 'ARM40', 'enableLog' : 'true', 'enableARM' : 'false'}},
